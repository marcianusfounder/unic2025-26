...
tags: [RAG, UNIC, DocumentoOficial, DOCX]
---

# SERIE C 3

> [!info] Fonte Original: SERIE C 3.docx

![Imagem DOCX](file:///C:/Users/adria/OneDrive/Documentos/Marcianus Founder/PLANOS DE ESTUDOS — UNIC 2025-26/Z - Fontes Originais (Raw)/Base de Dados RAG/Media/SERIE C 3_image3.png)

![Imagem DOCX](file:///C:/Users/adria/OneDrive/Documentos/Marcianus Founder/PLANOS DE ESTUDOS — UNIC 2025-26/Z - Fontes Originais (Raw)/Base de Dados RAG/Media/SERIE C 3_image1.png)

![Imagem DOCX](file:///C:/Users/adria/OneDrive/Documentos/Marcianus Founder/PLANOS DE ESTUDOS — UNIC 2025-26/Z - Fontes Originais (Raw)/Base de Dados RAG/Media/SERIE C 3_image2.png)

Faculdade de Engenharia

Série: C

Section one: Traditional wedding                                            (10 marks)
...
2 Which paragraph discusses the wedding preparations? Mention a sentence referring to preparation.

3 Identify in the last paragraph the sentence that refers to the financial help the couple receives.

Section two: Present perfect                                                        (5 marks)

Read the situations and complete the sentences using the present perfect. Choose from these verbs:

Section three: Linking words                                                    (5 marks)

Nota: A presença do telemóvel consigo ou o uso de relógio do pulso implica a anulação da prova imediatamente. Melhoria de nota é feita mediante uma prova oral (um debate de 10 minutos em Inglês).

___________________________________                         ___________________________________

MsC. Dombaxi André                                                                       Lizandra León Brizuela
